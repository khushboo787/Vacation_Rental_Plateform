...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> landLordExceptionHandler(HostException be,WebRequest wr){
		MyErrorDetails me=new MyErrorDetails();
		me.setMessage(be.getMessage());
		me.setTimestamp(LocalDateTime.now());
		me.setDescription(wr.getDescription(false));
	...
	public ResponseEntity<MyErrorDetails> tenantExceptionHandler(GuestException be,WebRequest wr){
		MyErrorDetails me=new MyErrorDetails();
		me.setMessage(be.getMessage());
		me.setTimestamp(LocalDateTime.now());
		me.setDescription(wr.getDescription(false));
